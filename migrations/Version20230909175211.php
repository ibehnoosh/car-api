 ...
 */
final class Version20230909175211 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE review (id INT NOT NULL, car_id INT DEFAULT NULL, review_text TEXT NOT NULL, star_rating INT NOT NULL, PRIMARY KEY(id))');
